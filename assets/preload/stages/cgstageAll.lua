function onCreate()
	-- background shit
	makeAnimatedLuaSprite('CGBG', 'weekcg/CGBG', -900,-830);
	...
	makeAnimatedLuaSprite('crowd-free', 'weekcg/crowd-free', 50, 100);
	scaleObject('crowd-free', 1.3,1.3);
	makeAnimatedLuaSprite('bopper1', 'weekcg/bopper1', -300, 100);
	scaleObject('bopper1', 1.3,1.3);
	makeAnimatedLuaSprite('crowd-free2', 'weekcg/crowd-free2',  230, 280);
	scaleObject('crowd-free2', 1.3,1.3);
	makeAnimatedLuaSprite('bopper2', 'weekcg/bopper2', -400, 260);
